...
//Krypto pickup assist time window in seconds. Players must be within 5 meters of a Krypto device for 10 seconds to pick up Krypto automatically. 0: Disabled (Default: 0)
