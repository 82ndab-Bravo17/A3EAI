...
_vehicle = 		(_this select 0) select 0;				//Object the event handler is assigned to. (the unit taking damage)
_hit = 			(_this select 0) select 1;				//Name of the selection where the unit was damaged. "" for over-all structural damage, "?" for unknown selections. 
