...
A3EAI_setupStaticSpawn = compileFinal preprocessFileLineNumbers format ["%1\compile\A3EAI_unit_spawning\A3EAI_setupStaticSpawn.sqf",A3EAI_directory];
...
//A3EAI_clearMissileWeapons = compileFinal preprocessFileLineNumbers format ["%1\compile\A3EAI_utilities\A3EAI_clearMissileWeapons.sqf",A3EAI_directory];
...
A3EAI_staticSpawn_init = compileFinal preprocessFileLineNumbers format ["%1\compile\A3EAI_utilities\A3EAI_staticSpawn_init.sqf",A3EAI_directory];
A3EAI_unitHasRadio = compileFinal preprocessFileLineNumbers format ["%1\compile\A3EAI_utilities\A3EAI_unitHasRadio.sqf",A3EAI_directory];
